...
using A2_Chinook_EFandLINQ;
using Microsoft.EntityFrameworkCore;

namespace A2_Chinook_EFandLINQ.Data;
...
public partial class ChinookContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        { 
            // This pulls the connection string named "ChinookConn" from App.config
            optionsBuilder.UseSqlServer("Name=ChinookConn");
        }
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Track>(entity =>
        {
            ...
            entity.HasOne(d => d.Album).WithMany(p => p.Tracks)
                ...
                .HasConstraintName("FK__Track__AlbumId__5DCAEF64");
        });
